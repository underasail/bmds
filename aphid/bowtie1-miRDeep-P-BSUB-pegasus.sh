...
| /nethome/mct30/gitclones/mirdeep2/essentials/randfold-2.0/randfold -noPS \
...
bowtie -a -v 0 \
/nethome/mct30/bmds/index/bt1-plant-precursors/G006_Gut_plant_precursors \
-f /nethome/mct30/bmds/reads/G006_Gut_F_trimmed_17-35_plants_filtered.fa \
...
samtools faidx /nethome/mct30/bmds/ref_genomes/plants/single/plant_genome.fasta
cut -f1,2 /nethome/mct30/bmds/ref_genomes/plants/single/plant_genome.fasta.fai \
