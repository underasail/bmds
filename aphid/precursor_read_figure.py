...
G006_bam = pysam.AlignmentFile('/nethome/mct30/bmds/SAM_out/G006_Gut_plant-precursors_bowtie1_a_T_mm0_gap0.sorted.bam')
G002_bam = pysam.AlignmentFile('/nethome/mct30/bmds/SAM_out/G002_Gut_plant-precursors_bowtie1_a_T_mm0_gap0.sorted.bam')
BTIRed_bam = pysam.AlignmentFile('/nethome/mct30/bmds/SAM_out/BTIRed_Gut_plant-precursors_bowtie1_a_T_mm0_gap0.sorted.bam')
...
#struct_names = []
#structs = []
#with open('/nethome/mct30/bmds/index/plant_precursors/exact_mirs_precursors_T.fass', 'r') as fass:
#    for name in fass:
#        name = name.rstrip('\n').lstrip('>').split('_')[0]
#        seq = next(f).rstrip('\n').replace('T', 'U')
...
#            struct_ind = struct_names.index(name)
