...
--sort_mem 5000M \
--outdir \
/nethome/mct30/acypi/sra/plants/ShortStack/ShortStack_6_20-24_f_300_SRA_q28_17-25_SRR799358 \
--genomefile /nethome/mct30/acypi/sra/plants/genome/GCF_000695525.1_BOL_genomic.fasta \
--readfile \
/nethome/mct30/acypi/sra/plants/read_files/expanded_GSM1110004_Boleracea_sample3_unique.fasta \
--mmap f \
--dicermin 20 \
--dicermax 24 \
--foldsize 300 \
