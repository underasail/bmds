...
#BSUB -e /nethome/mct30/err/miranda-parallel_miR-PREFeR.err
#BSUB -o /nethome/mct30/out/miranda-parallel_miR-PREFeR.out
#BSUB -P acypi
#BSUB -n 1
#BSUB -q general
#BSUB -W 24:00
...
miranda \
/nethome/mct30/bmds/miR-PREFeR_predictions_10X_20-24_300_2/G006_Gut_F_trimmed_17-35_plants_miRNA.mature_good_unique.fa \
/nethome/mct30/bmds/ref_genomes/G006-Myzus/G006_Myzus_genome_ref_three_prime_utr.fasta \
-sc 80 -go -8 -ge -2 -scale 2 -en 0 -strict -quiet \
-out /nethome/mct30/bmds/miR-PREFeR_predictions_10X_20-24_300_2/target_prediction/miranda/G006_Gut_F_trimmed_17-35_plants_miRNA.mature_good_unique_targets.out
