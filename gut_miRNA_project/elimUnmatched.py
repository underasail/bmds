...
# USAGE: python3 ./elimUnmatched.py [APHID SAM FILE] [BUCHNERA SAM FILE] \
...
with open(argv[1], newline='') as f:
    ...
    for row in csvreader:
        if (len(row) >= 14) and (('XM:i:0' or 'XM:i:1') in str(row)):
            ...
            # allows key to be created if not already 
            # and added to without disruption
